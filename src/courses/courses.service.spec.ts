...
describe('CoursesService', () => {
  ...
  it('should creates a course', async () => {
    ...
    const newCourse = await service.createCourse(createCourseDto)
  ...
  it('should list courses', async () => {
    ...
    const mockCourseRepository = {
      findAllCourses: jest.fn().mockReturnValue(Promise.resolve(expectOutputCourse)),
  ...
  it('should gets a course', async () => {
    ...
    const course = await service.findOneCourse(id)
  ...
  it('should updates a course', async () => {
    ...
    const course = await service.updateCourse(id, updateCourseDto)
  ...
  it('should deletes a course', async () => {
    ...
    const course = await service.removeCourse(id)
  ...
  //       courseRepository.findOne.mockRejectedValue(expectedCourse)
  //       const course = await service.findOneCourse(courseId)
  //       expect(course).toEqual(expectedCourse)
  //     })

  //     it('deve retornar um NotFoundException', async () => {
  //       const courseId = '1'
  //       courseRepository.findOne.mockRejectedValue(undefined)

  //       try {
  //         await service.findOneCourse(courseId)
  //       } catch (error) {
